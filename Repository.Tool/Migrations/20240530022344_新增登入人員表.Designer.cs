...
namespace Repository.Tool.Migrations
{
    ...
    [Migration("20240530022344_新增登入人員表")]
    partial class 新增登入人員表
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repository.Database.TMail", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasComment("主键标识ID");
            ...
            modelBuilder.Entity("Repository.Database.TPeople", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasComment("主键标识ID");
            ...
            modelBuilder.Entity("Repository.Database.TScore", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasComment("主键标识ID");
            ...
            modelBuilder.Entity("Repository.Database.TSubject", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasComment("主键标识ID");
            ...
            modelBuilder.Entity("Repository.Database.Tusers", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasComment("主键标识ID");
            ...
            modelBuilder.Entity("Repository.Database.TScore", b =>
                {
                    ...
                    b.HasOne("Repository.Database.TSubject", "Subject")
                        .WithMany("TScore")
            ...
            modelBuilder.Entity("Repository.Database.TStudent", b =>
                {
                    b.HasOne("Repository.Database.TClass", "Class")
                        .WithMany("TStudent")
